 ...
 */
    ...
    #define USBREGISTERS_H
        ...
        static inline CPU_RegSize_t USBReg_Get_Current_Endpoint(void);
        static inline void USBReg_Set_Current_Endpoint(const CPU_RegSize_t var);
        ...
        static inline void USBReg_Disable_All_USB_Interrupts(void);
             ...
             * 
             * @warning By default, ATMEGAXXU4_SERIES devices calibrate the internal 
             ...
             * 
             * @warning ATMEGAXXU4_SERIES devices support a maximum clock frequency
             ...
             * 8MHz. 
             * 
             * @note Based on user configurations in usb_config.h, this function
             ...
             * 
             * @return CPU_RegSize_t: The Endpoint Number currently being accessed by the CPU.
             * 
             */
            static inline CPU_RegSize_t USBReg_Get_Current_Endpoint(void)
            {
             ...
             * 
             * @warning @p ATMEGAXXU4_SERIES devices have 7 endpoints, so @p var 
             * must be less than 7.
             *
             */
            static inline void USBReg_Set_Current_Endpoint(const CPU_RegSize_t var)
            ...
            static inline void USBReg_Clear_All_Endpoints(void)
            {
                for (CPU_RegSize_t endp = (NUMBER_OF_USB_ENDPOINTS - 1); endp >= 0; endp--)
                {
