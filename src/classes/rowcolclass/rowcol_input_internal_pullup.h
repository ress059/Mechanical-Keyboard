/**
 * @file rowcol_input_internal_pullup.h
 * @author Ian Ress
...
#ifndef ROWCOL_INPUT_INTERNAL_PULLUP_CLASS_H_
#define ROWCOL_INPUT_INTERNAL_PULLUP_CLASS_H_
...
/*--------------------------------------------------------------------------------------------------------------------------*/
/*-------------------------------------------- ROWCOL INPUT INTERNAL PULLUP CLASS ------------------------------------------*/
/*--------------------------------------------------------------------------------------------------------------------------*/

/**
 * @brief The Rowcol Input Internal Pullup Class. Inherits the Base Rowcol Class and the Input Rowcol Class. Each 
 * Class Instance represents a Row/Column that uses an Input with Internal Pullup Resistors to detect Keypresses.
 */
typedef struct
{
    /* Inherit Rowcol Input Class which inherits Base Rowcol Class */
...
/**
 * @brief Rowcol Input Internal Pullup Class Constructor. Inherits the Base Rowcol Class and the Input Rowcol Class.
 * 
 * @param me Pointer to an instance of the Rowcol Input Internal Pullup Class. Note that SubClasses that inherit 
 * this Class will explicitly upcast to a (Rowcol_Input_Internal_Pullup *) to inherit this function in their own 
...
#endif /* ROWCOL_INPUT_INTERNAL_PULLUP_CLASS_H_ */
