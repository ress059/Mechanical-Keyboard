/**
 * @file rowcol_input_external_pulldown.h
 * @author Ian Ress
...
#ifndef ROWCOL_INPUT_EXTERNAL_PULLDOWN_CLASS_H_
#define ROWCOL_INPUT_EXTERNAL_PULLDOWN_CLASS_H_
...
/*--------------------------------------------------------------------------------------------------------------------------*/
/*-------------------------------------------- ROWCOL INPUT EXTERNAL PULLDOWN CLASS ----------------------------------------*/
/*--------------------------------------------------------------------------------------------------------------------------*/

/**
 * @brief The Rowcol Input External Pulldown Class. Inherits the Base Rowcol Class and the Input Rowcol Class. Each 
 * Class Instance represents a Row/Column that uses an Input with External Pulldown Resistors to detect Keypresses.
 */
typedef struct
{
    /* Inherit Rowcol Input Class which inherits Base Rowcol Class */
...
} Rowcol_Input_External_Pulldown;
...
/**
 * @brief Rowcol Input External Pulldown Class Constructor. Inherits the Base Rowcol Class and the Input Rowcol Class.
 * 
 * @param me Pointer to an instance of the Rowcol Input External Pulldown Class. Note that SubClasses that inherit 
 * this Class will explicitly upcast to a (Rowcol_Input_External_Pulldown *) to inherit this function in their own 
...
#endif /* ROWCOL_INPUT_EXTERNAL_PULLDOWN_CLASS_H_ */
