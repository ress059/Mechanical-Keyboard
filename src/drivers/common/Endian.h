 ...
 * TargetSpecific.h. USB is Little Endian so swapping macros will change based on if the
...
#else /* Big Endian. CompileChecks.h will check if Endianness is defined properly in TargetSpecific.h so we don't need an error guard here. */
