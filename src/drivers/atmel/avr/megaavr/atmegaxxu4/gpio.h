 ...
 * their keyboard in keyboard_config.h, while abstracting away the lower-level info needed for the gpio
 * driver. E.g. 
 ...
 * Therefore the keyboard settings in keyboard_config.h and the application code are 
