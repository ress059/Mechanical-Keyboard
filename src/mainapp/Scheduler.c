 ...
 * 
 * @param[in] taskhandler Callback to the task's function for the scheduler to execute. If the function requires
 * different arguments, the user should place it inside a wrapper function.
 * @param[in] taskfreq How often the task should execute in ms.
 * 
