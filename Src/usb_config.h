...
* so it can be included in the rest of the USB stack. This provides a portable way to create Descriptors
* and setup the USB device if the settings ever change.
*
* Author: Ian Ress
*
*/ 
