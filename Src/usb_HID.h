/** @file usb_HID.h
*
* @brief USB descriptor declarations and macros for HID Keyboard devices. This is separated out from the standard descriptor
* declarations for cleaner organization.
*
* Author: Ian Ress
*
*/ 
